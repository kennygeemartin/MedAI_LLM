...
function renderMessage(message) {
  ...
  const mode = {evidence:'Library excerpts',medgemma:'AI-assisted explanation',emergency:'Seek urgent help',no_evidence:'More guidance needed',referral:'Professional advice needed'}[message.mode];
